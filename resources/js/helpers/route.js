...
export function route(name, params = {}) {
  const routes = {
    ...
    'consignment-items.create': '/consignment-items/create',
    'consignment-items.show': '/consignment-items/:consignment',
    'consignment-items.edit': '/consignment-items/:consignment/edit',
    'consignment-items.store': '/consignment-items',
    'consignment-items.update': '/consignment-items/:consignment',
    'consignment-items.destroy': '/consignment-items/:consignment',
    'sales.index': '/sales',
